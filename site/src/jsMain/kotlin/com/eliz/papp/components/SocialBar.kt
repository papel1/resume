...
import com.eliz.papp.styles.SocialLinkStyle
import com.eliz.papp.util.Constants.GITHUB
import com.eliz.papp.util.Constants.LINKEDIN
...
{/*Link(
        path = "",
        openExternalLinksStrategy = OpenLinkStrategy.IN_NEW_TAB // Deprecated: OpenLinkStrategy.IN_NEW_TAB_FOREGROUND
    ) {
        FaFacebook(
