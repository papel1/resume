...
fun PortfolioCards(breakpoint: Breakpoint)
{
    Row(
        modifier = Modifier
                ...
                .margin(bottom = 25.px)
                .maxWidth(
                    if (breakpoint > Breakpoint.MD) 950.px else if (breakpoint > Breakpoint.SM) 625.px else 325.px
                )
